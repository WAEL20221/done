...
{
    public partial class DeliveryRequests : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Session["ANUser"] != null)
                {
                    ...
                    List<Order> blogs = DataAccess.Instance.GetOrders1DeliveryRequests();
    ...
    + "\\n " + "Date-التاريخ " + orderr.DataOrder + "order amount-مبلغ الطلب " + orderr.TotalPrice.ToString() + "SAR" + "\\n ");
                            ...
                            try
                            {
                                Response.Redirect("/AdminShops/DeliveryRequests.aspx", false);
                        //  Response.Redirect("/AdminShops/DeliveryRequests.aspx");
                    }
                    catch
                            {
        ...
        protected void btnview5_Click(object sender, EventArgs e)
        {
            ...
            if (Session["ANUser"] != null)
            {
                ...
                List<Order> blogs = DataAccess.Instance.GetOrders2DeliveryRequests();
        ...
        protected void btnview2_Click(object sender, EventArgs e)
        {
            ...
            if (Session["ANUser"] != null)
            {
                ...
                List<Order> blogs = DataAccess.Instance.GetOrdersByGetAccepetDeliveryRequests();
        ...
        protected void btnview3_Click(object sender, EventArgs e)
        {
            if (Session["ANUser"] != null)
            {
                ...
                List<Order> blogs = DataAccess.Instance.GetOrdersByGetGetDeliveryRequests();
        ...
        protected void btnview4_Click(object sender, EventArgs e)
        {
            if (Session["ANUser"] != null)
            {
                ...
                List<Order> blogs = DataAccess.Instance.GetOrdersByGetsessfulDeliveryRequests();
                //*
        ...
        protected void btnview6_Click(object sender, EventArgs e)
        {
            ...
            {
                string name = Session["ANUser"].ToString();
                List<Order> blogs = DataAccess.Instance.GetOrdersByGetFiledDeliveryRequests();
                //*
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<Order> blogs = DataAccess.Instance.GetOrdOrderidDeliveryRequests(ids);
                //*
        ...
        protected void Button18_Click(object sender, EventArgs e)
        {
            if (Session["ANUser"] != null)
            {
                ...
                List<Order> blogs = DataAccess.Instance.GetOrdersByGetAccepetDriver7DeliveryRequests();
        ...
        protected void Buttonfinsh_Click(object sender, EventArgs e)
        {
            ...
            if (TextBoxpassword.Text == "Aa2023")
            {
                int YesorNo = 0;
