<%@ Page Title="" Language="C#" Async="true" MasterPageFile="~/AdminShops/AdminUser.Master" AutoEventWireup="true" CodeBehind="OrdersTow.aspx.cs" Inherits="MyFast.AdminShops.OrdersTow" %>
    ...
    &nbsp;&nbsp;&nbsp;
        ...
        <asp:Button ID="Button223" OnClick="btnview4_Click" Font-Size="9"  CssClass="btn btn-outline-success btn-sm" runat="server" Text="منتهي" />&nbsp;&nbsp;&nbsp;
           <asp:Button ID="Button2" OnClick="btnview6_Click" Font-Size="9"  CssClass="btn btn-outline-danger btn-sm" runat="server" Text="مرفوض" />
             &nbsp;&nbsp;&nbsp;
           <asp:Button ID="Button32" OnClick="btnview9_Click" Font-Size="9"  CssClass="btn btn-outline-danger btn-sm" runat="server" Text="الشكوى" />
...
<tr>
      ...
      <td colspan="3">
          <asp:Button OnCommand="Button3_Command"    CommandName='<%# Eval("IdBosh") %>' ID="Button3" CssClass="btn btn-facebook btn-sm" runat="server" Text=" ارقام المتجر" />
           ...
           <asp:Button OnCommand="Button6_Command"  Font-Size="9"     CommandName='<%# Eval("Id") %>' ID="Button6" CssClass="btn btn-facebook btn-sm" runat="server" Text="رفض الطلب" /> 
          
          
          <asp:Button OnCommand="Button9_Command" Font-Size="9"    CommandName='<%# Eval("IdCustomer") %>' ID="Button9" CssClass="btn btn-facebook btn-sm" runat="server" Text=" تنبية للعميل" />
...
<tr>
   ...
   <asp:Button OnCommand="Button6_Command"   Font-Size="9"     CommandName='<%# Eval("Id") %>' ID="Button6" CssClass="btn btn-facebook btn-sm" runat="server" Text="قبول او رفض الطلب" /> 
                                             <asp:Button OnCommand="Button7_Command"  Font-Size="9"   CommandName='<%# Eval("Id") %>' ID="Button7" CssClass="btn btn-facebook btn-sm" runat="server" Text=" تنبية للمتجر" /> 
                                             <asp:Button OnCommand="Button8_Command"  Font-Size="9"   CommandName='<%# Eval("IDDriver") %>' ID="Button8" CssClass="btn btn-facebook btn-sm" runat="server" Text=" تنبية للمندوب" /> 
                                            <asp:Button OnCommand="Button9_Command"  Font-Size="9"  CommandName='<%# Eval("IdCustomer") %>' ID="Button9" CssClass="btn btn-facebook btn-sm" runat="server" Text=" تنبية للعميل" /> 
              <span runat="server" Visible='<%# (int)Eval("IDDriver")!=11 %>'>                           
          <asp:Button OnCommand="Button15_Command"      Font-Size="9"  CommandName='<%# Eval("Id") %>' ID="Button15" CssClass="btn btn-facebook btn-sm" runat="server" Text="اسناد" /> 
           </span>
...
<tr>
   ...
   <asp:Button OnCommand="Button6_Command" Visible='<%# Session["ANUser"] != null && Session["ANUser"].ToString() == "admin" || Session["ANUser"] != null && Session["ANUser"].ToString() == "الاء" || Session["ANUser"] != null && Session["ANUser"].ToString() == "aziz abdulah" || Session["ANUser"] != null && Session["ANUser"].ToString() == "ayman" || Session["ANUser"] != null && Session["ANUser"].ToString() == "اسراء" || Session["ANUser"] != null && Session["ANUser"].ToString() == "اسماء" %>'     Font-Size="9"  CommandName='<%# Eval("Id") %>'    ID="Button6" CssClass="btn btn-facebook btn-sm" runat="server" Text=" رفض الطلب" /> 
                                             <asp:Button OnCommand="Button7_Command"  Font-Size="9"   CommandName='<%# Eval("Id") %>' ID="Button7" CssClass="btn btn-facebook btn-sm" runat="server" Text=" تنبية للمتجر" /> 
                                             <asp:Button OnCommand="Button8_Command"  Font-Size="9"   CommandName='<%# Eval("IDDriver") %>' ID="Button8" CssClass="btn btn-facebook btn-sm" runat="server" Text=" تنبية للمندوب" /> 
                                            <asp:Button OnCommand="Button9_Command"  Font-Size="9"  CommandName='<%# Eval("IdCustomer") %>' ID="Button9" CssClass="btn btn-facebook btn-sm" runat="server" Text=" تنبية للعميل" /> 
             <span runat="server" Visible='<%# (int)Eval("IDDriver")!=11 %>'>                            
...
<asp:Button OnCommand="Button2DD8_Command"     Font-Size="9"  CommandName='<%# Eval("Id") %>' ID="Button2DD8" CssClass="btn btn-success btn-sm" runat="server" Text="اتمام الطلب" /> 
</span>
...
<tr>
      <th scope="row">اخرى</th>
      <td colspan="3">
   <asp:Button OnCommand="Button6_Command"   Font-Size="9" Visible="false"  CommandName='<%# Eval("Id") %>' ID="Button6" CssClass="btn btn-facebook btn-sm" runat="server" Text=" رفض الطلب" /> 
               <span runat="server" Visible='<%# Eval("PostalCode").ToString().Contains("storedone")  %>'  >
   <a href='<%# string.Format("/Uploads/ImageDriveComplaints/{0}",Eval("Note"))%>' target="_blank"> 
   <asp:Image ID="Image1" runat="server" Height="100px" Width="100px" ImageUrl='<%# string.Format("/Uploads/ImageDriveComplaints/{0}",Eval("Note"))%>'  />
</a>
...
<asp:Button OnCommand="Button14444335_Command"      Font-Size="9"  CommandName='<%# Eval("Id") %>' ID="Button28" CssClass="btn btn-outline-danger btn-sm" runat="server" Text="اسناد سريع" /> 
   ...
   <asp:Button OnCommand="Button5544_Command"  Visible="false"     Font-Size="9"  CommandName='<%# Eval("Id") %>' ID="Button5544" CssClass="btn btn-facebook btn-sm" runat="server" Text="ارجاعه مقبول" /> 
                                             ...
                                             <asp:Button OnCommand="Button7_Command"  Font-Size="9"   CommandName='<%# Eval("Id") %>' ID="Button7" CssClass="btn btn-facebook btn-sm" runat="server" Text=" تنبية للمتجر" /> 
                                             <asp:Button OnCommand="Button8_Command"  Font-Size="9"   CommandName='<%# Eval("IDDriver") %>' ID="Button8" CssClass="btn btn-facebook btn-sm" runat="server" Text=" تنبية للمندوب" /> 
                                            <asp:Button OnCommand="Button9_Command"  Font-Size="9"  CommandName='<%# Eval("IdCustomer") %>' ID="Button29" CssClass="btn btn-facebook btn-sm" runat="server" Text=" تنبية للعميل" /> 
...
<asp:Button OnCommand="Button2DD8_Command"     Font-Size="9"  CommandName='<%# Eval("Id") %>' ID="Button2DD8" CssClass="btn btn-success btn-sm" runat="server" Text="اتمام الطلب" /> 
 ...
 <asp:View ID="View10" runat="server">
        ...
        <h2 class="text-center mb-4">إدارة الشكاوى</h2>

        <!-- أزرار لتصفية الشكاوى -->
 <div class="text-center mb-4">
            <asp:Button ID="btnNew" runat="server" Text="جديدة" CssClass="btn btn-primary mx-1" CommandArgument="لا يوجد اي ملاحظة" OnClick="FilterComplaints22" />
            <asp:Button ID="btnInProgress" runat="server" Text="تحت المعالجة" CssClass="btn btn-warning mx-1" CommandArgument="تحت المعالجة" OnClick="FilterComplaints33" />
            <asp:Button ID="btnTransferred" runat="server" Text="تم تحويلها للإدارة" CssClass="btn btn-info mx-1" CommandArgument="تم تحويلها للإدارة" OnClick="FilterComplaints" />
            <asp:Button ID="btnResolved" runat="server" Text="منتهية" CssClass="btn btn-success mx-1" CommandArgument="منتهية" OnClick="FilterComplaints" />
        </div>
                                 
 
                          <!-- عرض الشكاوى بناءً على الفئة -->
         <div  class="row">

         
             <asp:ListView ID="ListView12" runat="server" DataKeyNames="Id" OnItemCommand="ListView12_ItemCommand">
    <LayoutTemplate>
   ...
   <ItemTemplate>
    ...
    <div class="col-md-6 col-xl-4 mb-4"> 
        <div class="card shadow-lg border-start border-4 border-info h-100 transition-all">
            <div class="card-body">
                <h5 class="card-title text-info d-flex align-items-center">
                    <i class="fas fa-bullhorn fa-lg me-2"></i> <strong>شكوى رقم:</strong> <%# Eval("Id") %>
                </h5>
                <p><i class="fas fa-user me-2"></i><strong> العميل:</strong> <%# Eval("Supname") %></p>
                <p><i class="fas fa-phone me-2"></i><strong> رقم العميل:</strong> <%# Eval("Supemail") %></p>
                <p><i class="fas fa-clock me-2"></i><strong> التاريخ:</strong> <%# Eval("SupDateTime") %></p>
                
                <h6><i class="fas fa-comment-alt me-2"></i><strong> الشكوى:</strong> <%# Eval("Supmasseg") %></h6>

                <!-- حالة جديدة -->
                <asp:Panel ID="pnlNew" runat="server" Visible='<%# Eval("SupNot").ToString() == "لا يوجد اي ملاحظة" || Eval("SupNot").ToString() == "There is no note" %>'>
                    <asp:Button ID="btnStartProcess" runat="server" Text="معالجة الشكوى"
                        CommandName="StartProcess" CommandArgument='<%# Eval("Id") %>' CssClass="btn btn-outline-primary btn-sm w-100" />
                </asp:Panel>

                <!-- تحت المعالجة -->
                 <asp:Panel ID="pnlUnderProcessing" runat="server" CssClass="border rounded p-2 mb-3 bg-light"
    Visible='<%# Eval("SupNot").ToString() == "تحت المعالجة" %>'>

    <asp:TextBox ID="txtNote" runat="server" CssClass="form-control form-control-sm mb-1" placeholder="أدخل الملاحظات" />
    <asp:TextBox ID="txtAction" runat="server" CssClass="form-control form-control-sm mb-2" placeholder="الإجراء المتخذ" />

    <asp:Button ID="Button33" runat="server" Text="📎 إرفاق صورة"
        CommandName="UploadImage" CommandArgument='<%# Eval("Id") %>'
        CssClass="btn btn-warning btn-sm w-100 mb-2" />

   


 <asp:ImageButton ID="ImageButton1" runat="server"
    ImageUrl='<%# "~/Uploads/chat/" + Eval("Image_path") %>'
    CssClass="img-thumbnail d-block mx-auto mb-2"
    Width="80" Height="80"
    Visible='<%# !string.IsNullOrEmpty(Eval("Image_path").ToString()) %>'
    CommandName="Image2Click"
   CommandArgument='<%# Eval("Id") %>' />


    <div class="d-flex justify-content-between mb-2">
        <asp:Button ID="btnComplete" runat="server" Text="✔ تمت المعالجة"
            CommandName="Complete" CommandArgument='<%# Eval("Id") %>'
            CssClass="btn btn-success btn-sm w-48" />
        <asp:Button ID="btnToAdmin" runat="server" Text="↪ تحويلها للإدارة"
            CommandName="ToAdmin" CommandArgument='<%# Eval("Id") %>'
            CssClass="btn btn-secondary btn-sm w-48" />
    </div>

    <p class="small text-muted mb-0"><i class="fas fa-user-check me-1"></i><strong>بواسطة:</strong> <%# Eval("User_StartProcess") %></p>
    <p class="small text-muted"><i class="fas fa-calendar-check me-1"></i><strong>بتاريخ:</strong> <%# Eval("Date_and_time_StartProcess") %></p>

</asp:Panel>


                <!-- تم تحويلها للإدارة -->
                 <asp:Panel ID="pnlToAdmin" runat="server" CssClass="border rounded p-2 mb-3 bg-light"
    Visible='<%# Eval("SupNot").ToString() == "تم تحويلها للإدارة" %>'>

    <asp:TextBox ID="txtAdminNote" runat="server" CssClass="form-control form-control-sm mb-1" placeholder="ملاحظات الإدارة" />
    <asp:TextBox ID="txtAdminAction" runat="server" CssClass="form-control form-control-sm mb-2" placeholder="إجراء الإدارة" />
   ...
   Width="80" Height="80"
   Visible='<%# !string.IsNullOrEmpty(Eval("Image_path").ToString()) %>'
   CommandName="Image3Click"
  CommandArgument='<%# Eval("Id") %>' />

    <asp:Button ID="btnAdminComplete" runat="server" Text="✔ تمت المعالجة"
        CommandName="Complete" CommandArgument='<%# Eval("Id") %>'
        CssClass="btn btn-success btn-sm w-100 mb-2" />

    <p class="small text-muted mb-1"><i class="fas fa-user-check me-1"></i><strong>بواسطة:</strong> <%# Eval("User_StartProcess") %></p>
    <p class="small text-muted mb-1"><i class="fas fa-calendar-check me-1"></i><strong>عند:</strong> <%# Eval("Date_and_time_StartProcess") %></p>

    <p class="small text-info mb-1"><i class="fas fa-arrow-circle-right me-1"></i><strong>إحالة للإدارة</strong></p>
    <p class="small text-muted mb-2"><i class="fas fa-calendar-check me-1"></i><strong>بتاريخ:</strong> <%# Eval("Date_and_time_ToAdmin") %></p>

    <span runat="server" Visible='<%# Eval("Note_ToAdmin") != DBNull.Value && Eval("Note_ToAdmin") != "" %>'>
        <p class="small mb-1"><i class="fas fa-comment-dots me-1"></i><strong>ملاحظات:</strong> <%# Eval("Note_ToAdmin") %></p>
    </span>

    <span runat="server" Visible='<%# Eval("Action_ToAdmin") != DBNull.Value && Eval("Action_ToAdmin") != "" %>'>
        <p class="small"><i class="fas fa-cogs me-1"></i><strong>الإجراء:</strong> <%# Eval("Action_ToAdmin") %></p>
    </span>
                ...
                <!-- منتهية -->
                <asp:Panel ID="pnlComplete" runat="server" CssClass="border rounded p-2 mb-3 shadow-sm bg-light"
    Visible='<%# Eval("SupNot").ToString() == "منتهية"  %>'>

    <div class="small text-muted">
        <hr class="my-2" />
        <p><i class="fas fa-user-check me-1 text-success"></i><strong> تم الاستلام:</strong> <%# Eval("User_StartProcess") %></p>

        <span runat="server" Visible='<%# Eval("Date_and_time_StartProcess")!= DBNull.Value && Eval("Date_and_time_StartProcess")!="" %>'>
            <p><i class="fas fa-calendar-alt me-1"></i><strong> عند:</strong> <%# Eval("Date_and_time_StartProcess") %></p>
        </span>

        <span runat="server" Visible='<%# Eval("Date_and_time_ToAdmin")!= DBNull.Value && Eval("Date_and_time_ToAdmin")!="" %>'>
            <p><i class="fas fa-share-square me-1 text-warning"></i><strong> إحالة للإدارة:</strong></p>
            <p><i class="fas fa-calendar-alt me-1"></i><strong> عند:</strong> <%# Eval("Date_and_time_ToAdmin") %></p>
        </span>

        <span runat="server" Visible='<%# Eval("Note_ToAdmin")!= DBNull.Value && Eval("Note_ToAdmin")!="" %>'>
            <p><i class="fas fa-comment-dots me-1"></i><strong> ملاحظات الإدارة:</strong> <%# Eval("Note_ToAdmin") %></p>
        </span>

        <span runat="server" Visible='<%# Eval("Action_ToAdmin")!= DBNull.Value && Eval("Action_ToAdmin")!="" %>'>
            <p><i class="fas fa-tools me-1"></i><strong> إجراء الإدارة:</strong> <%# Eval("Action_ToAdmin") %></p>
        </span>

        <p class="text-success"><i class="fas fa-check-double me-1"></i><strong> تم إغلاق الشكوى</strong></p>

        <span runat="server" Visible='<%# Eval("Date_and_time_Complete")!= DBNull.Value && Eval("Date_and_time_Complete")!="" %>'>
            <p><i class="fas fa-calendar-alt me-1"></i><strong> عند:</strong> <%# Eval("Date_and_time_Complete") %></p>
        </span>

        <span runat="server" Visible='<%# Eval("Note_Complete")!= DBNull.Value && Eval("Note_Complete")!="" %>'>
            <p><i class="fas fa-sticky-note me-1"></i><strong> ملاحظات الإغلاق:</strong> <%# Eval("Note_Complete") %></p>
        </span>

        <span runat="server" Visible='<%# Eval("Action_Complete")!= DBNull.Value && Eval("Action_Complete")!="" %>'>
            <p><i class="fas fa-cogs me-1"></i><strong> الإجراء النهائي:</strong> <%# Eval("Action_Complete") %></p>
        </span>
    </div>

    <asp:ImageButton ID="ImageButton3" runat="server"
        ImageUrl='<%# "~/Uploads/chat/" + Eval("Image_path") %>'
        CssClass="img-thumbnail d-block mx-auto mb-2 shadow"
        Width="80" Height="80"
        Visible='<%# !string.IsNullOrEmpty(Eval("Image_path").ToString()) %>'
        CommandName="Image4Click"
        CommandArgument='<%# Eval("Id") %>' />
</asp:Panel>
...
<div style="text-align:right;" class="modal fade" id="logoutModalConselOrder" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
 ...
 رقم الطلب<asp:Label ID="Label21" runat="server" Font-Size="Medium" Text=" " ForeColor="Black" Font-Bold="True"></asp:Label>
       ...
       اسم المتجر<asp:Label ID="Label1" runat="server" Font-Size="Medium" Text=" " ForeColor="Black" Font-Bold="True"></asp:Label>
                   ...
                   <br />        
            <asp:TextBox ID="TextBox1"    placeholder="كلمة السر"  runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red"></asp:TextBox>
            <br />
            <br />
    ...
    <div class="modal-dialog" role="document">
       ...
       رقم الطلب<asp:Label ID="Label13" runat="server" Font-Size="Medium" Text=" " ForeColor="Black" Font-Bold="True"></asp:Label>
        ...
        <div style=" text-align:center;" >
            ...
            <asp:TextBox ID="TextBox12"    placeholder="كلمة السر"  runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red"></asp:TextBox>
            <br />
            <br />
    ...
    <div class="modal-dialog" role="document">
       ...
       رقم الطلب<asp:Label ID="Label15" runat="server" Font-Size="Medium" Text=" " ForeColor="Black" Font-Bold="True"></asp:Label>
        ...
        <div style=" text-align:center;" >
            ...
            <asp:TextBox ID="TextBox13"    placeholder="كلمة السر"  runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red"></asp:TextBox>
            <br />
            <br />
       ...
       رقم الطلب<asp:Label ID="Label26" runat="server" Font-Size="Medium" Text=" " ForeColor="Black" Font-Bold="True"></asp:Label>
        ...
        <div style=" text-align:center;" >
                  <div class="table-responsive">
                   ...
                   <br />        
            <asp:TextBox ID="TextBox8"    placeholder="كلمة السر"  runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red"></asp:TextBox>
            <br />
            <br />
    ...
    <div class="modal-dialog" role="document">
       ...
       رقم الطلب<asp:Label ID="Label50Auto" runat="server" Font-Size="Medium" Text=" " ForeColor="Black" Font-Bold="True"></asp:Label>
        ...
        <div style=" text-align:center;" >
            ...
            <asp:TextBox ID="TextBox13Auto"    placeholder="كلمة السر"  runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red"></asp:TextBox>
            <br />
            <br />
       ...
       رقم الطلب<asp:Label ID="Label32" runat="server" Font-Size="Medium" Text=" " ForeColor="Black" Font-Bold="True"></asp:Label>
        ...
        <div style=" text-align:center;" >
                  <div class="table-responsive">
                   ...
                   <br />        
            <asp:TextBox ID="TextBox11"    placeholder="كلمة السر"  runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red"></asp:TextBox>
            <br />
            <br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title" id="uploadModalLabel">رفع صورة للشكوى</h5>
      ...
      <div class="modal-body">
        ...
        <!-- ملف رفع الصورة -->
            ...
            <asp:FileUpload ID="fuModal" runat="server" CssClass="form-control mb-3" />
            <asp:Button ID="btnUploadModal" runat="server" Text="رفع" CssClass="btn btn-success" OnClick="btnUploadModal_Click" />
            <asp:Label ID="lblModalResult" runat="server" ForeColor="Red" />
           <asp:Label ID="IdSus" runat="server" Font-Size="0" ForeColor="Red" />
